...
// 작성하는 것 과 동일하게 각 class별로 도출되어 2개가 된다
...
public class Ex01_Class {
	public static void main(String[] args) {
		...
		// 메서드를 선언한 클래스 안에서 메서드를 사용 할 때는 단순히 메서드명만
		...
		// 반환값이 있는 경우 반환하는 타입을 반환형에 명시해야 한다.
		// int , boolean 등 기본 자료형과 String 같은 참조 자료형도 가능하지만
		// 사용자가 만든 객체로도 반환이 가능하다
		// 아무것도 반환하지 않을 때ㅔ는 void
