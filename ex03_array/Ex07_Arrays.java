...
public class Ex07_Arrays {
	public static void main(String[] args) {
		...
		// 얕은 복사(Shallow Copy) : 복사된 배열이나 원본 배열이 변경될때 서로간의 값이 함께 변경된다.
		
		// 깊은 복사(Deep Copy) : 복사된 배열이나 원본 배열이 서로 변경될 때 서로간의 값은 바뀌지 않는다
		...
		// 직접 넣어주거나 Arrays 클래스 또는 System 클래스가 가진 기능을 이용한다.
		...
		System.out.println("newCards2 : " + Arrays.toString(newCards2));
		System.out.println("newCards3 : " + Arrays.toString(newCards3));
	}
}
